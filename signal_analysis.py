...
REFERENCE_METRICS = (
    ...
    "CTD50_ms_mean",
    "CTD90_ms_mean",
    "Max_contraction_slope_uN_per_s_mean",
    "Max_relaxation_slope_uN_per_s_mean",
)

BEAT_METRIC_COLUMNS = (
    "Peak_force_uN",
    "Diastolic_force_pre_uN",
    "Amplitude_uN",
    "Time_to_peak_ms",
    "Rise_10_90_ms",
    "Relaxation_50_ms",
    ...
    "CTD90_ms",
    "Signal_to_noise",
    "Max_contraction_slope_uN_per_s",
    "Max_relaxation_slope_uN_per_s",
)
...
def summary_display_columns(summary: pd.DataFrame) -> list[str]:
    ...
    preferred = [
        ...
        "Peak_force_uN_mean", "Peak_force_uN_mean_pct_baseline",
        "Amplitude_uN_mean", "Amplitude_uN_mean_pct_baseline",
        ...
        "Max_contraction_slope_uN_per_s_mean",
        "Max_contraction_slope_uN_per_s_mean_pct_baseline",
        "Max_relaxation_slope_uN_per_s_mean",
        "Max_relaxation_slope_uN_per_s_mean_pct_baseline",
...
SUMMARY_COLUMN_LABELS = {
    ...
    "Peak_force_uN_mean": "Peak force (µN)",
    "Peak_force_uN_mean_pct_baseline": "Peak force (% reference)",
    "Amplitude_uN_mean": "Amplitude (µN)",
    "Amplitude_uN_mean_pct_baseline": "Amplitude (% reference)",
    ...
    "Max_contraction_slope_uN_per_s_mean": "Max contraction slope (µN/s)",
    "Max_contraction_slope_uN_per_s_mean_pct_baseline": "Max contraction slope (% reference)",
    "Max_relaxation_slope_uN_per_s_mean": "Max relaxation slope (µN/s)",
    "Max_relaxation_slope_uN_per_s_mean_pct_baseline": "Max relaxation slope (% reference)",
}
...
def analyze_trace(time_values, force_values, trace_name: str, settings: AnalysisSettings):
    ...
    for peak_index, peak in enumerate(peaks):
        ...
        rows.append({
            ...
            "Beat": len(rows) + 1,
            "Peak_time_s": t[peak],
            "Peak_force_uN": smooth[peak],
            "Diastolic_force_pre_uN": smooth[left],
            "Diastolic_force_post_uN": smooth[right],
            "Amplitude_uN": amplitude,
            ...
            "Max_contraction_slope_uN_per_s": float(np.max(np.gradient(smooth[left:peak + 1], t[left:peak + 1]))),
            "Max_relaxation_slope_uN_per_s": float(np.min(np.gradient(smooth[peak:right + 1], t[peak:right + 1]))),
        })
    ...
    summary = {
        ...
        "Signal_range_1_99_uN": signal_range,
        "Peak_prominence_mode": settings.prominence_mode,
        "Peak_prominence_threshold_uN": prominence,
...
def failed_trace_summary(
    ...
    summary = {
        ...
        "Inverted": settings.invert,
        "Baseline_method": settings.baseline_method,
        "Signal_range_1_99_uN": np.nan,
        "Peak_prominence_mode": settings.prominence_mode,
        "Peak_prominence_threshold_uN": np.nan,
